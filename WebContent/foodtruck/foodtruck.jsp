		...
		<div class="tab-content">
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="product-item">
							<a href="foodtruckdetail.jsp"><img src="<%=root %>/images/food.PNG"
					...
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/food1.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
					...
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/food.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
									<a href="<%=root %>/foodtruck/foodtruckdetail.jsp">큐브 스테이크</a>
								</h3>
							</div>
						</div>
					</div>
			...
			<div class="tab-pane fade" id="desert">
				<div class="row">
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/desert1.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
					...
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/desert2.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
			...
			<div class="tab-pane fade" id="drink">
				<div class="row">
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/drink2.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
					...
					<div class="col-lg-3">
						<div class="product-item">
							<a href="<%=root %>/foodtruck/foodtruckdetail.jsp"><img src="<%=root %>/images/drink1.PNG"
								class="img-rounded" alt="Product Item" height="220" width="250"></a>
							<div class="info">
								<h3 class="title">
									<a href="<%=root %>/foodtruck/foodtruckdetail.jsp">아이스 아메리카노</a>
								</h3>
							</div>
						</div>
					</div>
