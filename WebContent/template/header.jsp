			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li id="nav-signup-btn"><a href="<%=root %>/base/signupcover.jsp">SignUp</a></li>
						<li class='login' id="nav-login-btn"><a href="<%=root %>/base/loginform.jsp">Login</a></li>
						<li class='logout' id="nav-logout-btn"><a href="<%=root %>/index.jsp">Logout</a></li>
					</ul>
					<%-- <ul class="nav navbar-nav navbar-right">
						<%String loginInfo = (String) session.getAttribute("loginInfo");
							if (loginInfo == null) {//로그인 안했을 때%>
						<li id="nav-signup-btn"><a href="signupcover.jsp">SignUp</a></li>
						<li class='login' id="nav-login-btn"><a href="loginform.jsp">Login</a></li>
						<%} else {//로그인 했을 때
							String userInfo = (String) session.getAttribute("loginInfo");
							if (userInfo.equals("0")) {//관리자분류번호%>
								<li id="nav-signup-btn"><a href="signupcover.jsp">SignUp</a></li><!-- 고치기 -->
								<li class='login' id="nav-login-btn"><a href="loginform.jsp">Login</a></li>
								<%} else if(userInfo.equals("1")){//사업자분류번호%>
								<li class="dropdown"><a href="#" class="dropdown-toggle"
								...
								<li class='logout' id="nav-logout-btn"><a href="index.jsp">Logout</a></li>
						<%}else{//일반회원일 때%>
						<li class="dropdown"><a href="#" class="dropdown-toggle"
							data-toggle="dropdown" role="button" aria-expanded="false">Mypage<span
								class="caret"></span>
